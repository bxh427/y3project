...
int main()
{
	...
	double thetastart;		// Starting bounce position measured as an angle from the positive x axis
	...
	double theta = thetastart; // Set changing variable theta equal to initial value
